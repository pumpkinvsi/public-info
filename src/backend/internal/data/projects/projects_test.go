...
type mockStore struct {
	ListProjectsGroupedFn func(ctx context.Context) ([]ProjectGroup, error)
}

func (m *mockStore) ListProjectsGrouped(ctx context.Context) ([]ProjectGroup, error) {
...
func TestGetProjects(t *testing.T) {
	...
	tests := []struct {
		name       string
		mockFn     func(ctx context.Context) ([]ProjectGroup, error)
		wantStatus int
		wantCount  int
	}{
		{
			...
			mockFn: func(ctx context.Context) ([]ProjectGroup, error) {
				return []ProjectGroup{
					{
						Technology: technologies.Technology{ID: 1, Name: "Go"},
						Projects: []Project{
							{
								ID:          1,
								...
								Note:        &note,
								Skills: []skills.Skill{
									{Name: "Go", Level: skills.Level{ID: 1, Level: 3, Text: "Senior"}},
								},
							},
						},
					},
			...
			return []ProjectGroup{
				{
					Technology: technologies.Technology{ID: 1, Name: "Go"},
					Projects: []Project{
						{ID: 1, Note: nil, Skills: []skills.Skill{}},
					},
				},
			}, nil
		},
